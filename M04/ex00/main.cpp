...
int main()
{
    std::cout << "=== Test 1: Virtual polymorphism (Animal/Dog/Cat) ===" << std::endl;
    ...
    std::cout << std::endl << "=== Test 2: Wrong polymorphism (WrongAnimal/WrongCat) ===" << std::endl;
    ...
    std::cout << std::endl << "=== Test 3: Direct Cat and Dog objects ===" << std::endl;
    Dog dog;
    Cat cat;
    dog.makeSound();
    cat.makeSound();
